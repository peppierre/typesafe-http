...
const rootDirectoryPath = path.normalize(path.join(__dirname, '..', 'workspace'));
const libraryDirectoryPath = path.normalize(path.join(rootDirectoryPath, 'projects', 'typesafe-http-iots'));
...
const baseRootPackageJsonPath = path.join(rootDirectoryPath, 'package.base.json');
...
fs.writeFileSync(baseRootPackageJsonPath, JSON.stringify(updatedRootPackageJson, null, 2), 'utf8');
