...
type JsonTyped<B, T>         = JsonBody<B>    & { runtimeType: iots.Type<T, unknown, unknown> };
type JsonEventsTyped<B, T>   = JsonEvents<B>  & { runtimeType: iots.Type<T, unknown, unknown> };
type JsonResponseTyped<B, T> = JsonResponse<B> & { runtimeType: iots.Type<T, unknown, unknown> };
