...
export class TypesafeHttpService {
  ...
  public put<T>    (url: string, body: any,  options?: any): Observable<ArrayBuffer | object | Blob | string | T > | Observable<HttpEvent<ArrayBuffer | object | Blob | string | T>> | Observable<HttpResponse<ArrayBuffer | string | object | Blob | T>> {
