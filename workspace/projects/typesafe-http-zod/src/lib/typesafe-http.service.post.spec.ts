...
describe('TypesafeHttpService', () => {
  ...
  describe('post(...) method', () => {
    ...
    describe('simple call-through functionality', () => {
      it('should return the same value as http.post', (done) => {
        // given
        mockHttpClient.post.mockReturnValue(of(SAMPLE_VEHICLE_TITLE));

        // when
        service.post(API_URL, null, { ...HTTP_OPTIONS, responseType: 'text'}).subscribe((response) => {
          // then
      ...
      it('should propagate error from http.post', (done) => {
        // given
        ...
        // when
        service.post(API_URL, null, { ...HTTP_OPTIONS, responseType: 'text'}).subscribe({
          next: () => {
            // then
    ...
    describe('response validation', () => {
      it('should accept valid response', (done) => {
        ...
        // when
        service
          .post<VehicleType>(API_URL, null, { ...HTTP_OPTIONS, runtimeType: VEHICLE })
          .subscribe((response) => {
            // then
      ...
      it('should reject invalid response', () => {
        ...
        // when
        try {
          service.post<VehicleType>(API_URL, null, { ...HTTP_OPTIONS, runtimeType: VEHICLE }).subscribe();
        } catch (error) {
          // then
