...
// --- Generalized Typed Options for Json (zod) ---
type JsonTypedOptionsBase<T>         = JsonBodyOptionsBase & { runtimeType: ZodType<T> };
type JsonEventsTypedOptionsBase<T>   = JsonEventsOptionsBase & { runtimeType: ZodType<T> };
type JsonResponseTypedOptionsBase<T> = JsonResponseOptionsBase & { runtimeType: ZodType<T> };
